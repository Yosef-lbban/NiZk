...
if edit then EditMsg(msg.chat_id_,msg.id_,'10% - |█    @yousef_labban     |') end
if edit then EditMsg(msg.chat_id_,msg.id_,'20% - |███  @yousef_labban       |') end
download_file('https://raw.githubusercontent.com/Yosef-lbban/nizk/root/YEMEN/Run.lua','./YEMEN/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████  @yousef_labban     |') end
download_file('https://raw.githubusercontent.com/Yosef-lbban/nizk/root/YEMEN/locks.lua','./YEMEN/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████  @yousef_labban   |') end
download_file('https://raw.githubusercontent.com/Yosef-lbban/nizk/root/YEMEN/Script.lua','./YEMEN/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████ @yousef_labban  |') end
download_file('https://raw.githubusercontent.com/Yosef-lbban/nizk/root/YEMEN/functions.lua','./YEMEN/functions.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'100% - |█████████████|\n\n تم تحديث السورس الى اصدار *v'..redis:get(js..":VERSION")..'*\n تم اعاده تشغيل السورس بنجاح\n Ch : *@yousef_labban1*') end
if edit then dofile("./YEMEN/Run.lua") end
print("Update Source And Reload ~ ./YEMEN/Run.lua")

end
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(js..":NameBot:") or "يوسف"
...
usernn = data.username_ or "yousef_labban1"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "yousef_labban1"
end
Name = Name:gsub('[[][]]','')
...
message = message ..i.. '-l ['..info.username..'](t.me/yousef_labban1) \n'
end
...
message = message ..k.. '-l ['..info.username..'](t.me/yousef_labban1) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
message = message ..k.. '-l ['..info.username..'](t.me/yousef_labban1) l » (`' ..v.. '`) \n'
end
end
end
...
elseif UserID == 1714422669 or UserID == 1755055191 then 
return sendMsg(ChatID,MsgID,"- لا يمكنك تقييد *مطورين يوسف* ؛") 
elseif redis:sismember(js..':SUDO_BOT:',UserID) then 
...
elseif UserID == 1714422669 or UserID == 1755055191 then 
return sendMsg(ChatID,MsgID,"- لا يمكنك طرد *مطورين يوسف* ؛") 
elseif UserID == SUDO_ID then 
...
elseif UserID == 1714422669 or UserID == 1755055191 then 
return sendMsg(ChatID,MsgID,"- لا يمكنك كتم *مطورين يوسف* ؛") 
elseif UserID == SUDO_ID then 
...
if UserID == 1714422669 or UserID == 1755055191 then return sendMsg(ChatID,MsgID,"- لا يمكنك تنفيذ الامر ضد *مطورين يوسف* ") end

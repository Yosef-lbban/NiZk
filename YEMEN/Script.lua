...
return sendMsg(msg.chat_id_,msg.id_,"♔ المالك :\n["..v.user.first_name.."](t.me/"..(v.user.username or "yousef_labban1"))
end
end
...
return sendMsg(arg.ChatID,arg.MsgID,"✶⁞ لا يمكنك تقييد *مطورين يوسف* ؛") 
...
return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تقييد *مطورين يوسف* ؛") 
...
elseif UserID == 1714422669 or UserID == 1755055191 then 
return sendMsg(arg.ChatID,arg.MsgID,"✶⁞ لا يمكنك طرد *مطورين يوسف*؛") 
elseif UserID == SUDO_ID then 
...
elseif UserID == 1714422669 or UserID == 1755055191 then 
return sendMsg(arg.ChatID,arg.MsgID,"✶⁞ لا يمكنك حظر *مطورين يوسف* ؛") 
elseif redis:sismember(js..':SUDO_BOT:',UserID) then 
...
elseif UserID == 1714422669 or UserID == 1755055191 then 
return sendMsg(arg.ChatID,arg.MsgID,"✶⁞ لا يمكنك كتم *مطورين يوسف* ؛") 
elseif redis:sismember(js..':SUDO_BOT:',UserID) then 
...
if UserID == 1714422669 or UserID == 1755055191 then return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تنفيذ الامر ضد *مطورين يوسف* \n") end
...
msg = arg.msg
if UserID == 1714422669 or UserID == 1755055191 then return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تنفيذ الامر ضد *مطورين يوسف* ") end
NameUser = Hyper_Link_Name(data)
...
return'✶⁞ اصدار سورس يوسف : *v'..version..'* '
end
...
if not msg.SudoBase then return " ⌯⁞  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://raw.githubusercontent.com/Yosef-lbban/kiindi.github.io/root/GetVersion.txt') or "0"
...
sendMsg(arg.chat_id_,arg.id_,'❦ عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس يوسف يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end  
else
...
local inline = {{{text="قناه‏‏ السـورس : يوسف ",url="t.me/yousef_labban1"}}}
send_key(msg.sender_user_id_,'  [قناة السورس: يوسف](t.me/yousef_labban1)',nil,inline,msg.id_)
return false
end
...
*~* [𝗖𝗵](T.ME/yousef_labban1) *,*
*~* [𝗗𝗲𝘃](T.ME/yousef_labban) *,*
*~* [𝗗𝗲𝘃](T.ME/yousef_labban) *.*
]]
end
if MsgText[1] == "متجر الملفات" or MsgText[1]:lower() == "/store"  then
if not msg.SudoBase then return " ⌯⁞  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local Get_Files, res = https.request("https:/Yosef-lbban.github.io/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
return " اوبس , هناك خطأ في مصفوفه الجيسون راسل *مطورين يوسف* ليتمكن من حل المشكله في اسرع وقت ممكن.!"
end
else
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/Yosef-lbban/MSaleMD.github.io/main/plugins/"..FileName)
if res == 200 then
...
return sendMsg(ChatID,MsgID,"✶⁞ لا يمكنك حظر *مطورين يوسف* ؛") 
end
if redis:sismember(js..'bannedpv',UserID) then 
...
return sendMsg(arg.ChatID,arg.id_,"- لا يمكنك حظر *مطورين يوسف* ؛") 
end
...
if CheckUserinstall(arg.USERNAME) then return sendMsg(arg.ChatID,arg.MsgID,"✶⁞ عذرا هذا الحساب محظور من سيرفرات حماية يوسف ") end
...
elseif Text== "مطور السورس" or Text== "سالم" or Text== "هيل" or Text== "ابو عمير" or Text== "عمير" or Text== "أبو عمير" then return sendMsg(msg.chat_id_,msg.id_,"[سـالِم.](T.ME/yousef_labban)")
